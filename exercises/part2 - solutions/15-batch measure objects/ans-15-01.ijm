...
// in a batch macro.
//
//* Complete the macro below and run it on the images in the folder 14. 
// Useful commands:
...
// 	run("Analyze Particles...", options);		- runs the particle analyzer with the given options. Use the macro-recorder to find the options.
