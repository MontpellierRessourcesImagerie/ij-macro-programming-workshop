...
// 
// Aim: Use a nested for-loop to iterate ofer the pixel of an image
//
...
newImage("pattern", "8-bit", 255, 255, 1);	// Creates a new image with the title "pattern", the type "8-bit", the width 255, the height 255 and 1 slice
run("16 colors");							// Applies a lookup-table (mapping of gray-values to colors) to the image.
width = getWidth();							// Get the width of the image.
height = getHeight();						// Get the heighth of the image.
